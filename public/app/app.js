...
.constant("firebaseURL", "https://front-end-capstone-402db.firebaseio.com/database/data")
...
app.run(($location) => {
	let eventRef = new Firebase("https://front-end-capstone-402db.firebaseio.com/");
